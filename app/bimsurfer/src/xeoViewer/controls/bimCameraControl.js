...
//      */
//     xeogl.BIMCameraControl = xeogl.CameraControl.extend({
...
//             var altDown = false; // True while shift key down
...
//             this._toolbarDragAction = "selector";
...
//                     if(input.keyDown[input.KEY_ALT]){
//                         altDown = true;
//                     }
//                     else
//                         altDown = false;
                    
//                     if(shiftDown && input.mouseDownLeft){
//                         self._defaultDragAction = "pan";
//                     }
//                     console.log(shiftDown, altDown);
//                     if(!shiftDown && input.mouseDownLeft && self._toolbarDragAction === "pan")
//                         self._defaultDragAction = "pan";
                    
//                     if(altDown && input.mouseDownLeft){
//                         self._defaultDragAction = "orbit";
//                     }
                    
//                     if(!altDown && input.mouseDownLeft && self._toolbarDragAction === "orbit")
//                         self._defaultDragAction = "orbit";
                    
//                     if(!altDown && !shiftDown && input.mouseDownLeft && self._toolbarDragAction === "selector")
//                         self._defaultDragAction = "selector";
...
//                     var center = [];
//                     // center.push(boundary.center[0]);
//                     // center.push(boundary.center[1]);
//                     // center.push(boundary.center[2]);
//                     center.push(0);
//                     center.push(0);
//                     center.push(0);
//                     // console.log("center" , boundary, center);
